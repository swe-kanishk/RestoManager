      ...
      <table className="w-full text-sm text-left text-gray-600 border border-gray-200 rounded-lg overflow-hidden">
          ...
          <tbody>
            ...
            <tr className=" font-semibold text-gray-900 border-t">
              ...
              <td colSpan={2} className={`!p-2 text-center ${data?.profitOrLoss === 'Profit' ? 'bg-green-400' : 'bg-red-400'}`}>
                {data?.profitOrLoss}
              </td>
            </tr>
            <tr className="bg-blue-400 font-semibold text-gray-900 border-t">
            ...
            <tr className=" font-semibold text-gray-900 border-t">
              <td colSpan={5} className={`!p-2 text-center ${data?.profitOrLoss === 'Loss' ? 'text-red-400' : 'text-green-600'}`}>
                {data?.profitOrLoss} of {data?.percentage}%
              </td>
            </tr>
          </tbody>
        </table>
