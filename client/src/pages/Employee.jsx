...
function Employee() {
  ...
  return (
    ...
    <div className='flex flex-col gap-[1rem]'>
      ...
      <Button onClick={() => context?.setOpenModel({open: true, type: "Add Employee"})} variant="contained" className='!w-fit gap-[0.5rem] !capitalize !font-[500]'><FaPlus /> Add New Employee</Button>
      </div>
      <EmployeeTable />
    </div>
    <Modal
